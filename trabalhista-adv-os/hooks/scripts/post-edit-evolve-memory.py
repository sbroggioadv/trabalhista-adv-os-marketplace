...
<COWORK>/trabalhista/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "trabalhista" / "cowork-state.json"
    ...
    pending_path = cowork / "trabalhista" / ".memory-evolver-pending.json"
